...
# ========== BOT TOKEN & ADMIN ID ==========
TOKEN = "7921571693:AAEShMkVK2QQMHAmea9fiHTVZbr6uqEgGxs"
ADMIN_ID = 5459323708
...
logs_files = ["logs.txt", "logs1.txt", "logs2.txt"]
...
def free_logs(message):
    ...
    if logs:
        file_path = f"free_logs_{message.from_user.id}.txt"
        with open(file_path, "w") as file:
            file.write(logs)
